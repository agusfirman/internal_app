...
<hr/> 
<form id="form_cimb" class="form-horizontal" action="cetak/print-out-cimb-old.php" method="post" target="_blank" >
	...
	<label class="col-sm-3 control-label">Nama Pemilik Rekening</label>
		<div class="col-sm-3">
		  <select class="form-control input-sm" name="nama"  id="nama" autofocus>
		  	...
		  	$query = mysql_query("select id, nama_dokter from dt_dokter where norek_cimb !='-' order by nama_dokter ASC");
